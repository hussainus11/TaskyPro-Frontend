...
export type FormField = {
  ...
  dbId?: number; // Database ID for permissions
  encryptInDb?: boolean; // Encrypt the value before storing in the database
  visibleChars?: number; // How many characters to show when displaying this field's value in the UI (0 = show all)
};
