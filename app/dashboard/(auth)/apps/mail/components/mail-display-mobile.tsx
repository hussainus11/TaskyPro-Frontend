...
import { isHTML, sanitizeEmailHTML } from "../utils";
          ...
          {mail && (
            <div className="flex flex-1 flex-col">
              ...
              <div className="flex-1 p-4 text-sm overflow-auto">
                {isHTML(mail.text) ? (
                  <div className="email-html-container" style={{ overflow: 'auto' }}>
                    <div 
                      className="prose prose-sm max-w-none dark:prose-invert [&_img]:max-w-full [&_img]:h-auto [&_table]:max-w-full [&_table]:overflow-x-auto [&_a]:text-primary [&_a]:underline"
                      dangerouslySetInnerHTML={{ __html: sanitizeEmailHTML(mail.text) }}
                      style={{
                  ...
                  <div className="whitespace-pre-wrap break-words">{mail.text}</div>
                )}
              </div>
