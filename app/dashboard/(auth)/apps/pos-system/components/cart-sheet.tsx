...
export default function POStSystemCartSheet({ setShowAssignOrderDialogAction, showTableSelection = false }: POStSystemCart) {
  const { cart, createOrder, createOrderDirectly, isCreatingOrder } = useStore();
